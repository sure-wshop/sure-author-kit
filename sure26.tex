% Author template for the SuRE Workshop at IJCAI 2026.
...
% ---------------------------------------------------------------
% SuRE Workshop settings -- please fill in before submitting
% ---------------------------------------------------------------

% Track: choose one of  long | short | position
\suretrack{long}

% Submission number (change to your submission number before submitting)
\suresubmissionnum{\#\#\#}

% Uncomment the line below for the camera-ready version;
% leave commented out for submission.
% \surecameraready
...
\pdfinfo{
/TemplateVersion (SuRE.IJCAI.2026.0)
}

\title{SuRE Workshop @ IJCAI 2026 -- Formatting Instructions}
...
\begin{abstract}
	The {\it SuRE Workshop} at IJCAI 2026 solicits papers across three
	tracks. This document provides the formatting instructions and serves
	as the author template.
\end{abstract}

\section{Introduction}

Papers for the SuRE Workshop at IJCAI 2026 must be submitted as PDF
({\em Portable Document Format}) files formatted for 8-1/2$''$ $\times$ 11$''$ paper.

\subsection{Length of Papers}

SuRE has three tracks with different page limits:
\begin{itemize}
	\item {\bf Long papers:} at most 7 pages of content, plus at most 2 pages for references / acknowledgements / contribution statement / ethics statement.
	\item {\bf Short papers:} at most 4 pages of content, plus at most 1 page for references / acknowledgements / contribution statement / ethics statement.
	\item {\bf Position papers:} at most 2 pages of content, plus at most 1 page for references / acknowledgements / contribution statement / ethics statement.
\end{itemize}
The limit on content pages is {\em strict}. Papers exceeding the limit will be desk rejected.

Set your track at the top of this file using {\tt \textbackslash{}suretrack\{long\}},
{\tt \textbackslash{}suretrack\{short\}}, or {\tt \textbackslash{}suretrack\{position\}}.
...
\section{\LaTeX{} Style Files}\label{stylefiles}

The \LaTeX{} style files for the SuRE Workshop are {\tt sure26.sty}
and {\tt sure26.tex}, and the Bib\TeX{} files are {\tt named.bst} and
	{\tt sure26.bib}. The \LaTeX{} style file is for version 2e of
\LaTeX{}, and the Bib\TeX{} style file is for version 0.99c of
Bib\TeX{} ({\em not} version 0.98i).

These \LaTeX{} files contain the source of the present document and
